...
public class checkout extends browserfactory{
	...
	public void checkout1() throws InterruptedException
	{
		...
		driver.findElement(By.xpath("/html[1]/body[1]/div[4]/div[2]/div[1]/div[3]/div[1]/div[1]/div[1]/ul[1]/li[3]/a[1]")).click();
		
		driver.findElement(By.xpath("//a[@class='sbl-btn btn-back btn-large']")).click();
